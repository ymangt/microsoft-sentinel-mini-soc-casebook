...
| [DET-004](docs/det-004-azure-suspicious-resource-change.md) | Suspicious Azure resource change | Investigate risky Azure Activity operations such as NSG rule writes or role assignment changes | `AzureActivity` | Complete: detected, investigated, contained, and resolved |
